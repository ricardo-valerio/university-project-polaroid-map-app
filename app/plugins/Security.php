	...
	public function getAcl()
	{
		if (!isset($this->persistent->acl)) {
			...
			$privateResources = array(
				...
				'user'     => array('profile', 'account', 'polaroids', 'routes', 'liked', 'following', 'personalInfo', 'accountSettings', 'dangerZone', 'follow', 'unfollow', 'unfollowFromProfile')
			);
			...
			$publicResources = array(
				...
				'index'    => array('index'),
				'find'     => array('index', 'polaroids', 'routes', 'users', 'all', 'allUsers', 'allPolaroids', 'allRoutes', 'country', 'usersInCountry', 'polaroidsInCountry'),
